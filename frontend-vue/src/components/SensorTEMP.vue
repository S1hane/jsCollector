                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <!-- Chart container -->
                            <div id="TEMP-chart_container" >
                                <div id="TEMP-y_axis"></div>
                                <div id="TEMP-demo_chart" ref="panel"></div>
                            </div>
                        ...
                        <div class="panel-footer">
                            ...
                            CPU Temperature: {{this.value}}C
                        </div>
                    </div>
                    <!-- Panel div end -->

                    <!-- Range slider chart-refresh control -->
                    <!-- <div class="TEMP-col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2">
...
let tempClient = new W3CWebSocket('ws://localhost:8080/', 'listen-temp')
  ...
  methods: {
    ...
    initChart () {
      magnitudeChart = new Rickshaw.Graph({
        element: document.querySelector('#TEMP-demo_chart'),
        width: '500',
        height: '180',
        renderer: 'line',
        min: 20,
      ...
      var y_axis = new Rickshaw.Graph.Axis.Y({
        ...
        ticks: 5,
        element: document.getElementById('TEMP-y_axis')
      })
    ...
    openWebSocketListener () {
      ...
      tempClient.onopen = () => {
        console.log('WebSocket tempClient Connected')
        this.connStatus = 'Connected'
      }

      tempClient.onclose = () => {
        console.log('echo-protocol tempClient Closed')
        this.connStatus = 'Disconnected'
      }

      tempClient.onmessage = (e) => {
