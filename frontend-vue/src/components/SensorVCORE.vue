                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">VCORE</h3>
                        </div>
                        <div class="panel-body">
                            <!-- Chart container -->
                            <div id="VCORE-chart_container" >
                                <div id="VCORE-y_axis"></div>
                                <div id="VCORE-demo_chart" ref="panel"></div>
                            </div>
                        ...
                        <div class="panel-footer">
                            ...
                            CPU Voltage: {{this.value}}v
                        </div>
                    </div>
                    <!-- Panel div end -->

                    <!-- Range slider chart-refresh control -->
                    <!-- <div class="VCORE-col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2">
...
let vCOREClient = new W3CWebSocket('ws://localhost:8080/', 'listen-vcore')
  ...
  methods: {
    ...
    initChart () {
      magnitudeChart = new Rickshaw.Graph({
        element: document.querySelector('#VCORE-demo_chart'),
        width: '500',
        height: '180',
        renderer: 'line',
        min: -0.1,
      ...
      var y_axis = new Rickshaw.Graph.Axis.Y({
        ...
        ticks: 5,
        element: document.getElementById('VCORE-y_axis')
      })
    ...
    openWebSocketListener () {
      ...
      vCOREClient.onopen = () => {
        console.log('WebSocket vCOREClient Connected')
        this.connStatus = 'Connected'
      }

      vCOREClient.onclose = () => {
        console.log('vCOREClient Closed')
        this.connStatus = 'Disconnected'
      }

      vCOREClient.onmessage = (e) => {
