                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">BCLK</h3>
                        </div>
                        <div class="panel-body">
                            <!-- Chart container -->
                            <div id="BCLK-chart_container" >
                                <div id="BCLK-y_axis"></div>
                                <div id="BCLK-demo_chart" ref="panel"></div>
                            </div>
                        ...
                        <div class="panel-footer">
                            ...
                            Bus Clock Speed: {{this.value}}Mhz
                        </div>
                    </div>
                    <!-- Panel div end -->

                    <!-- Range slider chart-refresh control -->
                    <!-- <div class="BCLK-col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2">
...
let bclkClient = new W3CWebSocket('ws://localhost:8080/', 'listen-bclk')
  ...
  methods: {
    ...
    initChart () {
      magnitudeChart = new Rickshaw.Graph({
        element: document.querySelector('#BCLK-demo_chart'),
        width: '500',
        height: '180',
        renderer: 'line',
        min: 0,
      ...
      var y_axis = new Rickshaw.Graph.Axis.Y({
        ...
        ticks: 5,
        element: document.getElementById('BCLK-y_axis')
      })
    ...
    openWebSocketListener () {
      ...
      bclkClient.onopen = () => {
        console.log('WebSocket bclkClient Connected')
        this.connStatus = 'Connected'
      }

      bclkClient.onclose = () => {
        console.log('echo-protocol bclkClient Closed')
        this.connStatus = 'Disconnected'
      }

      bclkClient.onmessage = (e) => {
