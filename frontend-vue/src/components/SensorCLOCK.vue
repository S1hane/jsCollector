                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <!-- Chart container -->
                            <div id="CLOCK-chart_container" >
                                <div id="CLOCK-y_axis"></div>
                                <div id="CLOCK-demo_chart" ref="panel"></div>
                            </div>
                        ...
                        <div class="panel-footer">
                            ...
                            CPU Speed: {{this.value}}Mhz
                        </div>
                    </div>
                    <!-- Panel div end -->

                    <!-- Range slider chart-refresh control -->
                    <!-- <div class="CLOCK-col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2">
...
let clockClient = new W3CWebSocket('ws://localhost:8080/', 'listen-clock')
  ...
  methods: {
    ...
    initChart () {
      magnitudeChart = new Rickshaw.Graph({
        element: document.querySelector('#CLOCK-demo_chart'),
        width: '500',
        height: '180',
        renderer: 'line',
        min: 800,
      ...
      var y_axis = new Rickshaw.Graph.Axis.Y({
        ...
        ticks: 5,
        element: document.getElementById('CLOCK-y_axis')
      })
    ...
    openWebSocketListener () {
      ...
      clockClient.onopen = () => {
        console.log('WebSocket clockClient Connected')
        this.connStatus = 'Connected'
      }

      clockClient.onclose = () => {
        console.log('echo-protocol clockClient Closed')
        this.connStatus = 'Disconnected'
      }

      clockClient.onmessage = (e) => {
        if (typeof e.data === 'string') {
          promiseToParseAndUpdateState(parseInt(e.data.slice(1, -1))).then((result) => {
